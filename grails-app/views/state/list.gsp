				...
				<table>
					...
					<g:each in="${stateInstanceList}" status="i" var="stateInstance">
						<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
							...
							<td><g:link action="edit" id="${stateInstance.id}">Edit</g:link></td>
							<td><g:link class="delete" action="delete" id="${stateInstance.id}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');">Delete</g:link></td>
						</tr>
					</g:each>
					</tbody>
				</table>
