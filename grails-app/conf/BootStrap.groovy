...
import harbor.Type;
import harbor.Asset;
import harbor.LoanAction;
import harbor.LoanActionReason;
...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		new Location(location: "Issued", moreSpecific: "", updates: [:]).save(failOnError:true)
		...
		println "Creating loan actions..."
		new LoanAction(action:"Distribution").save(failOnError:true)
		new LoanAction(action:"Return").save(failOnError:true)
		new LoanAction(action:"Swap").save(failOnError:true)
		
		println "Creating loan action reasons..."
		new LoanActionReason(reason:"Hardware Failure").save(failOnError:true)
		new LoanActionReason(reason:"User Damage").save(failOnError:true)
		new LoanActionReason(reason:"Upgrade").save(failOnError:true)
		new LoanActionReason(reason:"None").save(failOnError:true)
		new LoanActionReason(reason:"Termination").save(failOnError:true)
		new LoanActionReason(reason:"Return").save(failOnError:true)
